...
if select == "HOME":
    ...
    with col1:
        st.header(":violet[PhonePe]",divider="rainbow")
        st.subheader("Simple, Fast & Secure")
        st.divider()
        st.markdown('<p style="font-size: 20px; color: lightblue;">Features</p>', unsafe_allow_html=True)
        ...
        st.divider()
    with col2:
        st.image(Image.open(r"C:\Users\HP\Phonepe\logo1.jpg"),width= 500)

    col3,col4= st.columns(2)
    
    with col3:
        video_file = open(r'C:\Users\HP\Phonepe\shorts.mp4', 'rb')
    ...
    with col4:
        ...
        st.markdown(" ")
        st.divider()
        st.write("****View Statements & Manage Financial Data Consents****")
        st.write("****Accept Payments For Your Online Business At Zero Cost****")
    ...
    with col5:
        ...
        st.markdown(" ")
        st.divider()
        st.write("****One Payment Solution For All Business Needs****")
        st.write("****Pay Directly From Any Bank To Any Bank A/C****")
        st.write("****Invest in Stocks Easily****")
        st.divider()

    with col6:
        st.image(Image.open(r"C:\Users\HP\Phonepe\logo3.jpg"),width= 600)
    ...
    with tab2:
        ...
        if method_2 == "Map Transaction":
            ...
            with col1:
               ...
               years = st.slider("Select The Year", map_transaction["Years"].min(), map_transaction["Years"].max(), map_transaction["Years"].min(), key="year_slider")
